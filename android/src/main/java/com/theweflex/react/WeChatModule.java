...
public class WeChatModule extends ReactContextBaseJavaModule implements IWXAPIEventHandler {
    ...
    private void _getImage(Uri uri, ResizeOptions resizeOptions, final ImageCallback imageCallback) {
        BaseBitmapReferenceDataSubscriber dataSubscriber = new BaseBitmapReferenceDataSubscriber() {
            @Override
            protected void onNewResultImpl(@javax.annotation.Nullable CloseableReference<Bitmap> bitmapReference) {
